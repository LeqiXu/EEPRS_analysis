...
disease="CAD"
CAD_icd10 <- c(paste0('I21',c(0,1,2,3,4,9)), paste0('I22',c(0,1,8,9)),
               paste0('I23',c(1,6,8)),paste0('I24',c(1)),paste0('I25',c(2)))
CAD_icd9 <- c(paste0('410',9),paste0('411',9),paste0('412',9))
CAD_ops <- c(paste0('K40',c(1:4)),paste0('K41',c(1:4)),
             paste0('K45',c(1:5)),paste0('K49',c(1,2,8,9)),
             paste0('K50',c(2)),paste0('K75',c(1:4,8,9)))
CAD_s1 <- c(1075)
CAD_s2 <- c(1070,1095,1523)
...
ukbb_CAD = case_summary[,c("eid","CAD")]
ukbb_CAD = na.omit(ukbb_CAD)
ukbb_CAD$CAD = ifelse(ukbb_CAD$CAD == 0, 0, 1)
print(table(ukbb_CAD$CAD))

write.table(ukbb_CAD,paste0(output_path,'ukbb_',disease,'.tsv'),
	    quote=F,sep='\t',row.names=F)