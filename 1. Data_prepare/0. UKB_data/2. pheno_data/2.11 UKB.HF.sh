...
disease='HF'
HF_icd10 <- c('I110','I130','I132','I255','I420','I425',
                   'I428','I429','I500','I1501','I1509')
HF_icd9 <- c('4280','4281','4289','4254')
HF_ops <- NULL
HF_s1 <- NULL
HF_s2 <- NULL
...
ukbb_HF = case_summary[,c("eid","HF")]
ukbb_HF = na.omit(ukbb_HF)
ukbb_HF$HF = ifelse(ukbb_HF$HF == 0, 0, 1)
print(table(ukbb_HF$HF))

write.table(ukbb_HF,paste0(output_path,'ukbb_',disease,'.tsv'),
	    quote=F,sep='\t',row.names=F)