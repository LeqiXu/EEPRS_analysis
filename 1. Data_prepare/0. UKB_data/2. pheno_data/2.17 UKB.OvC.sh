...
ukbb_OvC = case_summary[,c("eid","OvC")]
ukbb_OvC = na.omit(ukbb_OvC)
ukbb_OvC$OvC = ifelse(ukbb_OvC$OvC == 0, 0, 1)
print(table(ukbb_OvC$OvC))

write.table(ukbb_OvC,paste0(output_path,'ukbb_',disease,'.tsv'),
	    quote=F,sep='\t',row.names=F)