...
disease="PAD"
PAD_icd10 <- c('I7000','I7001','I7020','I7021','I7080','I7081','I7090','I7091',
                'I738','I739')
PAD_icd9 <- c('4400','4402','4438','4439')
PAD_ops <- c('X093','X094','X095','L216','L513','L516','L518','L521','L522','L541',
                'L544','L548','L591','L592','L593','L594','L595','L596','L597','L598',
                'L601','L602','L631','L635','L639','L667')
PAD_s1 <- c(1067,1087,1088)
PAD_s2 <- c(1102,1108,1440)
...
ukbb_PAD = case_summary[,c("eid","PAD")]
ukbb_PAD = na.omit(ukbb_PAD)
ukbb_PAD$PAD = ifelse(ukbb_PAD$PAD == 0, 0, 1)
print(table(ukbb_PAD$PAD))

write.table(ukbb_PAD,paste0(output_path,'ukbb_',disease,'.tsv'),
	    quote=F,sep='\t',row.names=F)